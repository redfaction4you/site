      ...
      replace.push(
        db.insert(dmPlayers).values(
          round.players.map((player) => ({
            ...
            powerupAmps: player.powerupAmps,
            powerupInvulns: player.powerupInvulns,
            powerupSuperArmors: player.powerupSuperArmors,
            powerupSuperHealths: player.powerupSuperHealths,
